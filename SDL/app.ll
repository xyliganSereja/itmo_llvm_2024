...
define dso_local void @_Z9init_gamePA512_iS0_(ptr nocapture noundef writeonly %0, ptr nocapture noundef readnone %1) local_unnamed_addr #0 {
  br label %3
...
9:                                                ; preds = %3, %9
  %10 = phi i64 [ 0, %3 ], [ %14, %9 ]
  %11 = tail call noundef i32 @_Z7simRandv()
  %12 = srem i32 %11, 2
...
; Function Attrs: mustprogress sspstrong uwtable
define dso_local void @_Z4drawPA512_iS0_(ptr nocapture noundef readonly %0, ptr nocapture noundef readnone %1) local_unnamed_addr #0 {
  br label %3
...
10:                                               ; preds = %3, %10
  ...
  tail call void @_Z11simPutPixeliii(i32 noundef %16, i32 noundef %5, i32 noundef %15)
  %17 = add nuw nsw i64 %11, 1
  %18 = icmp eq i64 %17, 512
  br i1 %18, label %7, label %10, !llvm.loop !13
}

declare void @_Z11simPutPixeliii(i32 noundef, i32 noundef, i32 noundef) local_unnamed_addr #2

declare void @_Z8simFlushv() local_unnamed_addr #2

; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(argmem: read) uwtable
define dso_local noundef i32 @_Z9get_stateiiPA512_iS0_(i32 noundef %0, i32 noundef %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readnone %3) local_unnamed_addr #3 {
  %5 = or i32 %1, %0
  %6 = icmp sgt i32 %5, -1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(argmem: read) uwtable
define dso_local noundef i32 @_Z14get_count_neibiiPA512_iS0_(i32 noundef %0, i32 noundef %1, ptr nocapture noundef readonly %2, ptr nocapture noundef readnone %3) local_unnamed_addr #3 {
  %5 = add nsw i32 %1, -1
  %6 = or i32 %5, %0
  %7 = icmp sgt i32 %6, -1
...
define dso_local void @_Z6updatePA512_iS0_(ptr nocapture noundef %0, ptr nocapture noundef %1) local_unnamed_addr #4 {
...
8:                                                ; preds = %8, %3
  %9 = phi i64 [ 0, %3 ], [ %13, %8 ]
  %10 = tail call noundef i32 @_Z7simRandv()
  %11 = srem i32 %10, 2
...
23:                                               ; preds = %23, %15
  ...
  tail call void @_Z11simPutPixeliii(i32 noundef %29, i32 noundef %17, i32 noundef %28)
...
32:                                               ; preds = %18
  tail call void @_Z8simFlushv()
  call void @_Z6updatePA512_iS0_(ptr noundef nonnull %1, ptr noundef nonnull %2)
  br label %21
}
...
attributes #4 = { mustprogress nofree norecurse nosync nounwind sspstrong memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #5 = { mustprogress noreturn sspstrong uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
